...
class Vehicle:
    def __init__(self):
        ...
        self.labelframe_engine.grid(column=0, row=1, padx=5, pady=10, sticky = "WE")        
        
        self.label_engine = tk.Label(self.labelframe_engine, text = str(self.engine))
        self.label_engine.pack() #grid(column=1, row=0)
